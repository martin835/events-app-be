...
const events_router_1 = __importDefault(require("./services/routers/events-router"));
const organizers_router_1 = __importDefault(require("./services/routers/organizers-router"));
...
app.use("/organizers", organizers_router_1.default);
// For test purposes
...
app.use(errorHandlers_1.genericErrorHandler);
exports.default = app;
