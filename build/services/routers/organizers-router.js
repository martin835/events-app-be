...
const organizer_model_js_1 = __importDefault(require("../models/organizer-model.js"));
...
organizersRouter.get("/", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const organizers = yield organizer_model_js_1.default.find({});
        res.send(organizers);
    }
    catch (error) {
        next(error);
...
organizersRouter.post("/", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newOrganizer = new organizer_model_js_1.default(req.body);
...
organizersRouter.get("/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const organizer = yield organizer_model_js_1.default.findById(req.params.id);
        if (organizer) {
            res.send(organizer);
        }
        else {
